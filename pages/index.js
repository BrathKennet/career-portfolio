...
export default function Home() {
  return (
    ...
    <div class="flex flex-col justify-center items-center h-[100vh] bg-slate-500">
            <div class="!z-5 relative flex flex-col rounded-[20px] max-w-[300px] bg-white bg-clip-border shadow-3xl shadow-shadow-500  w-full !p-4 3xl:p-![18px]  undefined">
                <div class="h-full w-full">
                    ...
                    <div class="flex items-center justify-between md:items-center lg:justify-between ">
                        ...
                        <button href="" class="linear rounded-[20px] bg-black px-4 py-2 text-base font-medium text-white transition duration-200 hover:bg-brand-800 active:bg-brand-700">Place Bid</button>
                    </div>
                </div>
            </div>
        </div>
